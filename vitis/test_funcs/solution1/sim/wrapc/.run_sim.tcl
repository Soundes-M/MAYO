...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "test_func.autotvin.dat"
	set constFileTvOut       "test_func.autotvout.dat"
	set constFileHdlTvIn     "test_func.autohdltvin.dat"
	set constFileHdlTvOut    "test_func.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
