...
HD_PWD='/home/osm/Documents/SECT-MAYO/MAYO/vivado/SHAKE_Saber/SHAKE_Saber.runs/blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_0_1.tcl
