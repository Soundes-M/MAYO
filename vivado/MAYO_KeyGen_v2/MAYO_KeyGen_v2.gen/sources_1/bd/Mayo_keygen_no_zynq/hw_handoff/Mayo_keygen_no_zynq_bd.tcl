...
proc create_hier_cell_hash { parentCell nameHier } {
  ...
  # Create instance: MAYO_SHAKE_0, and set properties
  set MAYO_SHAKE_0 [ create_bd_cell -type ip -vlnv user.org:user:MAYO_SHAKE:2.0 MAYO_SHAKE_0 ]
  ...
  connect_bd_net -net MAYO_SHAKE_0_BRAMA_addr [get_bd_pins MAYO_SHAKE_0/BRAMA_addr] [get_bd_pins mayo_hash_bram_arbit_0/hash_addr]
  connect_bd_net -net MAYO_SHAKE_0_BRAMA_din [get_bd_pins MAYO_SHAKE_0/BRAMA_din] [get_bd_pins mayo_hash_bram_arbit_0/hash_din]
  connect_bd_net -net MAYO_SHAKE_0_BRAMA_en [get_bd_pins MAYO_SHAKE_0/BRAMA_en] [get_bd_pins mayo_hash_bram_arbit_0/hash_en]
  connect_bd_net -net MAYO_SHAKE_0_BRAMA_we [get_bd_pins MAYO_SHAKE_0/BRAMA_we] [get_bd_pins mayo_hash_bram_arbit_0/hash_we]
  connect_bd_net -net MAYO_SHAKE_0_done [get_bd_pins o_key_done] [get_bd_pins MAYO_SHAKE_0/done]
  connect_bd_net -net MAYO_SHAKE_0_dyn_done [get_bd_pins o_key_dyn_done] [get_bd_pins MAYO_SHAKE_0/dyn_done]
  connect_bd_net -net MAYO_SHAKE_0_o_control [get_bd_pins MAYO_SHAKE_0/o_control] [get_bd_pins mayo_hash_bram_arbit_0/hash_control]
  connect_bd_net -net bram_sel_1 [get_bd_pins bram_sel] [get_bd_pins mayo_hash_bram_arbit_0/bram_sel]
  connect_bd_net -net i_key_en_1 [get_bd_pins i_key_en] [get_bd_pins MAYO_SHAKE_0/en]
  connect_bd_net -net i_key_mlen_1 [get_bd_pins i_key_mlen] [get_bd_pins MAYO_SHAKE_0/mlen]
  connect_bd_net -net i_key_olen_1 [get_bd_pins i_key_olen] [get_bd_pins MAYO_SHAKE_0/olen]
  connect_bd_net -net i_key_read_adr_1 [get_bd_pins i_key_read_adr] [get_bd_pins MAYO_SHAKE_0/read_adr]
  connect_bd_net -net i_key_write_adr_1 [get_bd_pins i_key_write_adr] [get_bd_pins MAYO_SHAKE_0/write_adr]
  ...
  connect_bd_net -net mayo_hash_bram_arbit_0_hash_dout [get_bd_pins MAYO_SHAKE_0/BRAMA_dout] [get_bd_pins mayo_hash_bram_arbit_0/hash_dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk] [get_bd_pins MAYO_SHAKE_0/clk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst] [get_bd_pins MAYO_SHAKE_0/rst]
