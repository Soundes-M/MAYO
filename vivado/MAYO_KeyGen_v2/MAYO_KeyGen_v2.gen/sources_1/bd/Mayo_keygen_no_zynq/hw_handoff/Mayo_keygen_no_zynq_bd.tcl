...
proc create_hier_cell_BRAM_small { parentCell nameHier } {
  ...
  connect_bd_net -net BRAM_hash_we_1 [get_bd_pins Zero_4] [get_bd_pins arbit_brama0/BRAM_sam_we] [get_bd_pins arbit_bramb0/BRAM_hash_we] [get_bd_pins arbit_bramb0/BRAM_neg_we] [get_bd_pins arbit_bramb0/BRAM_red_we]
  ...
  connect_bd_net -net BRAM_neg_din1_1 [get_bd_pins Zero_32] [get_bd_pins arbit_brama0/BRAM_sam_addr] [get_bd_pins arbit_brama0/BRAM_sam_din] [get_bd_pins arbit_bramb0/BRAM_hash_addr] [get_bd_pins arbit_bramb0/BRAM_hash_din] [get_bd_pins arbit_bramb0/BRAM_neg_addr] [get_bd_pins arbit_bramb0/BRAM_neg_din] [get_bd_pins arbit_bramb0/BRAM_red_addr] [get_bd_pins arbit_bramb0/BRAM_red_din]
...
proc create_hier_cell_BRAM_big { parentCell nameHier } {
  ...
  connect_bd_net -net BRAM_add_rst_1 [get_bd_pins BRAM_add_rst] [get_bd_pins arbit_brama1/BRAM_add_en] [get_bd_pins arbit_brama1/BRAM_add_rst] [get_bd_pins arbit_brama1/BRAM_hash_rst] [get_bd_pins arbit_brama1/BRAM_neg_en] [get_bd_pins arbit_brama1/BRAM_neg_rst] [get_bd_pins arbit_brama1/BRAM_sam_en] [get_bd_pins arbit_brama1/BRAM_sam_rst] [get_bd_pins arbit_brama1/add_control] [get_bd_pins arbit_brama1/neg_control] [get_bd_pins arbit_brama1/sam_control]
  connect_bd_net -net BRAM_add_we_1 [get_bd_pins BRAM_add_we] [get_bd_pins arbit_brama1/BRAM_add_we] [get_bd_pins arbit_brama1/BRAM_neg_we] [get_bd_pins arbit_brama1/BRAM_sam_we]
  ...
  connect_bd_net -net BRAM_neg_din_1 [get_bd_pins BRAM_neg_din] [get_bd_pins arbit_brama1/BRAM_add_addr] [get_bd_pins arbit_brama1/BRAM_add_din] [get_bd_pins arbit_brama1/BRAM_neg_addr] [get_bd_pins arbit_brama1/BRAM_neg_din] [get_bd_pins arbit_brama1/BRAM_sam_addr] [get_bd_pins arbit_brama1/BRAM_sam_din]
