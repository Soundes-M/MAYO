...
# module references:
# MAYO_KEYGEN_FSM, mayo_linear_combination, mayo_negate, mayo_reduce, mayo_sample_oil_space, mayo_bram_arbiter, mayo_bram_arbiter, mayo_bram_arbiter, mayo_trng_arbiter, mayo_add_vectors, mayo_add_vectors_arbiter, mayo_hash_bram_arbiter
...
proc create_hier_cell_hash { parentCell nameHier } {
  ...
  set MAYO_SHAKE_1 [ create_bd_cell -type ip -vlnv user.org:user:MAYO_SHAKE:1.5 MAYO_SHAKE_1 ]
  set_property -dict [ list \
   CONFIG.C_READ_DESC_SIZE {32} \
   CONFIG.C_WRITE_DESC_SIZE {200} \
 ] $MAYO_SHAKE_1
...
proc create_hier_cell_add_vectors { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 1 -to 0 bram_sel
  create_bd_pin -dir I clk
  create_bd_pin -dir I -from 31 -to 0 i_BRAM0_dout
  create_bd_pin -dir I -from 31 -to 0 i_BRAM1_dout
  ...
  create_bd_pin -dir O -from 31 -to 0 o_BRAM0_addr
  create_bd_pin -dir O o_BRAM0_control
  create_bd_pin -dir O -from 31 -to 0 o_BRAM0_din
  create_bd_pin -dir O o_BRAM0_en
  create_bd_pin -dir O -type rst o_BRAM0_rst
  create_bd_pin -dir O -from 3 -to 0 o_BRAM0_we
  create_bd_pin -dir O -from 31 -to 0 o_BRAM1_addr
  create_bd_pin -dir O o_BRAM1_control
  create_bd_pin -dir O -from 31 -to 0 o_BRAM1_din
  create_bd_pin -dir O o_BRAM1_en
  create_bd_pin -dir O -type rst o_BRAM1_rst
  create_bd_pin -dir O -from 3 -to 0 o_BRAM1_we
  ...
  # Create port connections
  connect_bd_net -net BRAM_add_en_1 [get_bd_pins o_BRAM0_en] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_en]
  connect_bd_net -net BRAM_add_rst_1 [get_bd_pins o_BRAM0_rst] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_rst]
  connect_bd_net -net BRAM_big_BRAM_add_dout [get_bd_pins i_BRAM1_dout] [get_bd_pins mayo_add_vectors_arb_0/i_BRAM1_dout]
  connect_bd_net -net BRAM_small_BRAM_add_dout [get_bd_pins i_BRAM0_dout] [get_bd_pins mayo_add_vectors_arb_0/i_BRAM0_dout]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_bram_sel [get_bd_pins bram_sel] [get_bd_pins mayo_add_vectors_arb_0/bram_sel]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_enable [get_bd_pins i_enable] [get_bd_pins mayo_add_vectors_0/i_enable]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_out_addr [get_bd_pins i_out_addr] [get_bd_pins mayo_add_vectors_0/i_out_addr]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_v1_addr [get_bd_pins i_v1_addr] [get_bd_pins mayo_add_vectors_0/i_v1_addr]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_v2_addr [get_bd_pins i_v2_addr] [get_bd_pins mayo_add_vectors_0/i_v2_addr]
  connect_bd_net -net add_control_1 [get_bd_pins o_BRAM0_control] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_control]
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins mayo_add_vectors_0/i_clk]
  connect_bd_net -net mayo_add_vectors_0_o_controla [get_bd_pins mayo_add_vectors_0/o_controla] [get_bd_pins mayo_add_vectors_arb_0/i_controla]
  connect_bd_net -net mayo_add_vectors_0_o_controlb [get_bd_pins mayo_add_vectors_0/o_controlb] [get_bd_pins mayo_add_vectors_arb_0/i_controlb]
  connect_bd_net -net mayo_add_vectors_0_o_controlc [get_bd_pins mayo_add_vectors_0/o_controlc] [get_bd_pins mayo_add_vectors_arb_0/i_controlc]
  connect_bd_net -net mayo_add_vectors_0_o_done [get_bd_pins o_done] [get_bd_pins mayo_add_vectors_0/o_done]
  connect_bd_net -net mayo_add_vectors_0_o_mema_addr [get_bd_pins mayo_add_vectors_0/o_mema_addr] [get_bd_pins mayo_add_vectors_arb_0/i_mema_addr]
  connect_bd_net -net mayo_add_vectors_0_o_mema_din [get_bd_pins mayo_add_vectors_0/o_mema_din] [get_bd_pins mayo_add_vectors_arb_0/i_mema_din]
  connect_bd_net -net mayo_add_vectors_0_o_mema_en [get_bd_pins mayo_add_vectors_0/o_mema_en] [get_bd_pins mayo_add_vectors_arb_0/i_mema_en]
  connect_bd_net -net mayo_add_vectors_0_o_mema_rst [get_bd_pins mayo_add_vectors_0/o_mema_rst] [get_bd_pins mayo_add_vectors_arb_0/i_mema_rst]
  connect_bd_net -net mayo_add_vectors_0_o_mema_we [get_bd_pins mayo_add_vectors_0/o_mema_we] [get_bd_pins mayo_add_vectors_arb_0/i_mema_we]
  connect_bd_net -net mayo_add_vectors_0_o_memb_addr [get_bd_pins mayo_add_vectors_0/o_memb_addr] [get_bd_pins mayo_add_vectors_arb_0/i_memb_addr]
  connect_bd_net -net mayo_add_vectors_0_o_memb_din [get_bd_pins mayo_add_vectors_0/o_memb_din] [get_bd_pins mayo_add_vectors_arb_0/i_memb_din]
  connect_bd_net -net mayo_add_vectors_0_o_memb_en [get_bd_pins mayo_add_vectors_0/o_memb_en] [get_bd_pins mayo_add_vectors_arb_0/i_memb_en]
  connect_bd_net -net mayo_add_vectors_0_o_memb_rst [get_bd_pins mayo_add_vectors_0/o_memb_rst] [get_bd_pins mayo_add_vectors_arb_0/i_memb_rst]
  connect_bd_net -net mayo_add_vectors_0_o_memb_we [get_bd_pins mayo_add_vectors_0/o_memb_we] [get_bd_pins mayo_add_vectors_arb_0/i_memb_we]
  connect_bd_net -net mayo_add_vectors_0_o_memc_addr [get_bd_pins mayo_add_vectors_0/o_memc_addr] [get_bd_pins mayo_add_vectors_arb_0/i_memc_addr]
  connect_bd_net -net mayo_add_vectors_0_o_memc_din [get_bd_pins mayo_add_vectors_0/o_memc_din] [get_bd_pins mayo_add_vectors_arb_0/i_memc_din]
  connect_bd_net -net mayo_add_vectors_0_o_memc_en [get_bd_pins mayo_add_vectors_0/o_memc_en] [get_bd_pins mayo_add_vectors_arb_0/i_memc_en]
  connect_bd_net -net mayo_add_vectors_0_o_memc_rst [get_bd_pins mayo_add_vectors_0/o_memc_rst] [get_bd_pins mayo_add_vectors_arb_0/i_memc_rst]
  connect_bd_net -net mayo_add_vectors_0_o_memc_we [get_bd_pins mayo_add_vectors_0/o_memc_we] [get_bd_pins mayo_add_vectors_arb_0/i_memc_we]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_addr [get_bd_pins o_BRAM0_addr] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_addr]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_din [get_bd_pins o_BRAM0_din] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_din]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_we [get_bd_pins o_BRAM0_we] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM0_we]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_addr [get_bd_pins o_BRAM1_addr] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_addr]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_control [get_bd_pins o_BRAM1_control] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_control]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_din [get_bd_pins o_BRAM1_din] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_din]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_en [get_bd_pins o_BRAM1_en] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_en]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_rst [get_bd_pins o_BRAM1_rst] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_rst]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_we [get_bd_pins o_BRAM1_we] [get_bd_pins mayo_add_vectors_arb_0/o_BRAM1_we]
  connect_bd_net -net mayo_add_vectors_arb_0_o_mema_dout [get_bd_pins mayo_add_vectors_0/i_mema_dout] [get_bd_pins mayo_add_vectors_arb_0/o_mema_dout]
  connect_bd_net -net mayo_add_vectors_arb_0_o_memb_dout [get_bd_pins mayo_add_vectors_0/i_memb_dout] [get_bd_pins mayo_add_vectors_arb_0/o_memb_dout]
  connect_bd_net -net mayo_add_vectors_arb_0_o_memc_dout [get_bd_pins mayo_add_vectors_0/i_memc_dout] [get_bd_pins mayo_add_vectors_arb_0/o_memc_dout]
  connect_bd_net -net rst_1 [get_bd_pins rst] [get_bd_pins mayo_add_vectors_0/rst]
...
proc create_hier_cell_BRAM_small { parentCell nameHier } {
  ...
  connect_bd_net -net BRAM_hash_rst_1 [get_bd_pins Zero0] [get_bd_pins arbit_brama0/BRAM_hash_rst] [get_bd_pins arbit_brama0/BRAM_sam_en] [get_bd_pins arbit_brama0/BRAM_sam_rst] [get_bd_pins arbit_brama0/sam_control] [get_bd_pins arbit_bramb0/BRAM_add_en] [get_bd_pins arbit_bramb0/BRAM_add_rst] [get_bd_pins arbit_bramb0/BRAM_hash_en] [get_bd_pins arbit_bramb0/BRAM_hash_rst] [get_bd_pins arbit_bramb0/BRAM_neg_en] [get_bd_pins arbit_bramb0/BRAM_neg_rst] [get_bd_pins arbit_bramb0/BRAM_red_en] [get_bd_pins arbit_bramb0/BRAM_red_rst] [get_bd_pins arbit_bramb0/add_control] [get_bd_pins arbit_bramb0/hash_control] [get_bd_pins arbit_bramb0/neg_control] [get_bd_pins arbit_bramb0/red_control]
  connect_bd_net -net BRAM_hash_we1_1 [get_bd_pins BRAM_hash_we1] [get_bd_pins arbit_brama0/BRAM_hash_we]
  connect_bd_net -net BRAM_hash_we_1 [get_bd_pins Zero_4] [get_bd_pins arbit_brama0/BRAM_sam_we] [get_bd_pins arbit_bramb0/BRAM_add_we] [get_bd_pins arbit_bramb0/BRAM_hash_we] [get_bd_pins arbit_bramb0/BRAM_neg_we] [get_bd_pins arbit_bramb0/BRAM_red_we]
  ...
  connect_bd_net -net BRAM_neg_din1_1 [get_bd_pins Zero_32] [get_bd_pins arbit_brama0/BRAM_sam_addr] [get_bd_pins arbit_brama0/BRAM_sam_din] [get_bd_pins arbit_bramb0/BRAM_add_addr] [get_bd_pins arbit_bramb0/BRAM_add_din] [get_bd_pins arbit_bramb0/BRAM_hash_addr] [get_bd_pins arbit_bramb0/BRAM_hash_din] [get_bd_pins arbit_bramb0/BRAM_neg_addr] [get_bd_pins arbit_bramb0/BRAM_neg_din] [get_bd_pins arbit_bramb0/BRAM_red_addr] [get_bd_pins arbit_bramb0/BRAM_red_din]
...
proc create_hier_cell_BRAM_big { parentCell nameHier } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst] [get_bd_pins arbit_brama1/rst]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net BRAM_add_en_1 [get_bd_pins BRAM_small/BRAM_add_en] [get_bd_pins add_vectors/o_BRAM0_en]
  connect_bd_net -net BRAM_add_rst_1 [get_bd_pins BRAM_small/BRAM_add_rst] [get_bd_pins add_vectors/o_BRAM0_rst]
  connect_bd_net -net BRAM_big_BRAM_add_dout [get_bd_pins BRAM_big/BRAM_add_dout] [get_bd_pins add_vectors/i_BRAM1_dout]
  ...
  connect_bd_net -net BRAM_small_BRAM_add_dout [get_bd_pins BRAM_small/BRAM_add_dout] [get_bd_pins add_vectors/i_BRAM0_dout]
  connect_bd_net -net Ground0_dout [get_bd_pins BRAM_big/BRAM_add_rst] [get_bd_pins BRAM_small/Zero0] [get_bd_pins Ground0/dout] [get_bd_pins MAYO_KEYGEN_FSM_0/i_debug]
  ...
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_bram_sel [get_bd_pins MAYO_KEYGEN_FSM_0/o_add_bram_sel] [get_bd_pins add_vectors/bram_sel]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_enable [get_bd_pins MAYO_KEYGEN_FSM_0/o_add_enable] [get_bd_pins add_vectors/i_enable]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_out_addr [get_bd_pins MAYO_KEYGEN_FSM_0/o_add_out_addr] [get_bd_pins add_vectors/i_out_addr]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_v1_addr [get_bd_pins MAYO_KEYGEN_FSM_0/o_add_v1_addr] [get_bd_pins add_vectors/i_v1_addr]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_add_v2_addr [get_bd_pins MAYO_KEYGEN_FSM_0/o_add_v2_addr] [get_bd_pins add_vectors/i_v2_addr]
  ...
  connect_bd_net -net add_control_1 [get_bd_pins BRAM_small/add_control] [get_bd_pins add_vectors/o_BRAM0_control]
  ...
  connect_bd_net -net mayo_add_vectors_0_o_done [get_bd_pins MAYO_KEYGEN_FSM_0/i_add_done] [get_bd_pins add_vectors/o_done]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_addr [get_bd_pins BRAM_small/BRAM_add_addr] [get_bd_pins add_vectors/o_BRAM0_addr]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_din [get_bd_pins BRAM_small/BRAM_add_din] [get_bd_pins add_vectors/o_BRAM0_din]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM0_we [get_bd_pins BRAM_small/BRAM_add_we] [get_bd_pins add_vectors/o_BRAM0_we]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_addr [get_bd_pins BRAM_big/BRAM_add_addr] [get_bd_pins add_vectors/o_BRAM1_addr]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_control [get_bd_pins BRAM_big/add_control] [get_bd_pins add_vectors/o_BRAM1_control]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_din [get_bd_pins BRAM_big/BRAM_add_din] [get_bd_pins add_vectors/o_BRAM1_din]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_en [get_bd_pins BRAM_big/BRAM_add_en] [get_bd_pins add_vectors/o_BRAM1_en]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_rst [get_bd_pins BRAM_big/BRAM_add_rst1] [get_bd_pins add_vectors/o_BRAM1_rst]
  connect_bd_net -net mayo_add_vectors_arb_0_o_BRAM1_we [get_bd_pins BRAM_big/BRAM_add_we1] [get_bd_pins add_vectors/o_BRAM1_we]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins BRAM_big/rst] [get_bd_pins BRAM_small/rst] [get_bd_pins MAYO_KEYGEN_FSM_0/RESET] [get_bd_pins TRNG/rst] [get_bd_pins add_vectors/rst] [get_bd_pins hash/rst] [get_bd_pins mayo_linear_combinat_0/rst] [get_bd_pins mayo_negate_0/rst] [get_bd_pins mayo_reduce_0/rst] [get_bd_pins mayo_sample_oil_space_0/rst]
