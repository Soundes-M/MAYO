...
proc create_hier_cell_BigBRAM2 { parentCell nameHier } {
  ...
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_rst [get_bd_pins BigBRAM_3_256K/rstb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_rst]
  ...
  connect_bd_net -net mayo_bram_arbiter2_1_BRAM_rst [get_bd_pins BigBRAM_3_256K/rsta] [get_bd_pins mayo_bram_arbiter2_a/BRAM_rst]
...
proc create_hier_cell_BigBRAM1 { parentCell nameHier } {
  ...
  connect_bd_net -net BigBRAM_2_256K_doutb [get_bd_pins BigBRAM_2_256K/doutb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_dout]
  connect_bd_net -net clk_0_1 [get_bd_pins clk_0] [get_bd_pins BigBRAM_2_256K/clka] [get_bd_pins BigBRAM_2_256K/clkb]
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_addr [get_bd_pins BigBRAM_2_256K/addrb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_addr]
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_din [get_bd_pins BigBRAM_2_256K/dinb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_din]
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_en [get_bd_pins BigBRAM_2_256K/enb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_en]
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_rst [get_bd_pins BigBRAM_2_256K/rstb] [get_bd_pins mayo_bram_arbiter2_b/BRAM_rst]
  connect_bd_net -net mayo_bram_arbiter2_0_BRAM_we [get_bd_pins BigBRAM_2_256K/web] [get_bd_pins mayo_bram_arbiter2_b/BRAM_we]
