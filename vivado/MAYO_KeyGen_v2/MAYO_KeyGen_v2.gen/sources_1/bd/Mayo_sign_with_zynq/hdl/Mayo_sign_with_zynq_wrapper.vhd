...
entity Mayo_sign_with_zynq_wrapper is
  port (
...
architecture STRUCTURE of Mayo_sign_with_zynq_wrapper is
  ...
  end component Mayo_sign_with_zynq;
begin
Mayo_sign_with_zynq_i: component Mayo_sign_with_zynq
     port map (
