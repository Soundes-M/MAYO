...
proc create_hier_cell_BRAM_small { parentCell nameHier } {
  ...
  connect_bd_net -net arbit_brama0_BRAM_en [get_bd_pins BRAM_en] [get_bd_pins Small_BRAM8k/ena] [get_bd_pins arbit_brama0/BRAM_en]
...
# Hierarchical cell: BRAM_big1
proc create_hier_cell_BRAM_big1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_BRAM_big1() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: BIG_BRAM256KDP, and set properties
  set BIG_BRAM256KDP [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BIG_BRAM256KDP ]
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
   CONFIG.EN_SAFETY_CKT {true} \
   CONFIG.Enable_32bit_Address {true} \
  ...
  # Create instance: BIG_BRAM256KDP1, and set properties
  set BIG_BRAM256KDP1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 BIG_BRAM256KDP1 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
   CONFIG.EN_SAFETY_CKT {true} \
   CONFIG.Enable_32bit_Address {true} \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins BIG_BRAM256KDP/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]

  # Create port connections
  connect_bd_net -net BIG_BRAM256KDP_doutb [get_bd_pins BIG_BRAM256KDP/doutb] [get_bd_pins arbit_brama1/BRAM_dout]
  ...
  connect_bd_net -net arbit_brama1_BRAM_addr [get_bd_pins BIG_BRAM256KDP/addrb] [get_bd_pins arbit_brama1/BRAM_addr]
  connect_bd_net -net arbit_brama1_BRAM_din [get_bd_pins BIG_BRAM256KDP/dinb] [get_bd_pins arbit_brama1/BRAM_din]
  connect_bd_net -net arbit_brama1_BRAM_en [get_bd_pins BRAM_en] [get_bd_pins BIG_BRAM256KDP/enb] [get_bd_pins arbit_brama1/BRAM_en]
  ...
  connect_bd_net -net arbit_brama1_BRAM_rst [get_bd_pins BIG_BRAM256KDP/rstb] [get_bd_pins arbit_brama1/BRAM_rst]
  connect_bd_net -net arbit_brama1_BRAM_we [get_bd_pins BIG_BRAM256KDP/web] [get_bd_pins arbit_brama1/BRAM_we]
  connect_bd_net -net bram_control_1 [get_bd_pins bram_control] [get_bd_pins arbit_brama1/bram_control]
  connect_bd_net -net clka_1 [get_bd_pins clkb] [get_bd_pins BIG_BRAM256KDP/clkb]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Ground5, and set properties
  set Ground5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Ground5 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0000} \
   CONFIG.CONST_WIDTH {4} \
 ] $Ground5

  # Create instance: Ground33, and set properties
  set Ground33 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 Ground33 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins BRAM_big1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins mayo_axi_litev3_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net BRAM0_dout_1 [get_bd_pins BRAM_small/BRAM_hash_dout] [get_bd_pins hash/BRAM0_dout]
  connect_bd_net -net BRAM_big1_BRAM_en [get_bd_pins BRAM_big1/BRAM_en] [get_bd_pins blink_led_0/in4]
  connect_bd_net -net BRAM_big_BRAM_add_dout [get_bd_pins BRAM_big1/BRAM_add_dout] [get_bd_pins mayo_add_vectors_0/i_memc_dout]
  connect_bd_net -net BRAM_big_BRAM_red_dout [get_bd_pins BRAM_big1/BRAM_red_dout] [get_bd_pins mayo_reduce_0/i_dout1]
  connect_bd_net -net BRAM_key_addr1_1 [get_bd_pins BRAM_small/BRAM_key_addr1] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem0b_addr]
  connect_bd_net -net BRAM_key_addr_1 [get_bd_pins BRAM_big1/BRAM_key_addr] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem1a_addr]
  connect_bd_net -net BRAM_key_rst1_1 [get_bd_pins BRAM_small/BRAM_key_rst1] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem0b_rst]
  connect_bd_net -net BRAM_key_rst_1 [get_bd_pins BRAM_big1/BRAM_key_rst] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem1a_rst]
  ...
  connect_bd_net -net BRAM_small_BRAM_en [get_bd_pins BRAM_small/BRAM_en] [get_bd_pins blink_led_0/in5]
  connect_bd_net -net Ground1_dout [get_bd_pins BRAM_big1/BRAM_add_rst] [get_bd_pins BRAM_small/Zero0] [get_bd_pins Ground1/dout] [get_bd_pins blink_led_0/in2] [get_bd_pins blink_led_0/in3] [get_bd_pins mayo_axi_litev3_0/i_Signing_busy] [get_bd_pins mayo_axi_litev3_0/i_Signing_done] [get_bd_pins mayo_axi_litev3_0/i_Verification_busy] [get_bd_pins mayo_axi_litev3_0/i_Verification_done]
  ...
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_done [get_bd_pins MAYO_KEYGEN_FSM_0/o_done] [get_bd_pins blink_led_0/in0] [get_bd_pins mayo_axi_litev3_0/i_Keygen_done] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MAYO_KEYGEN_FSM_0_o_done]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_err [get_bd_pins MAYO_KEYGEN_FSM_0/o_err] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_hash_en [get_bd_pins MAYO_KEYGEN_FSM_0/o_hash_en] [get_bd_pins hash/i_key_en] [get_bd_pins system_ila_0/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MAYO_KEYGEN_FSM_0_o_hash_en]
  ...
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_lin_enable [get_bd_pins MAYO_KEYGEN_FSM_0/o_lin_enable] [get_bd_pins mayo_linear_combinat_0/i_enable] [get_bd_pins system_ila_0/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MAYO_KEYGEN_FSM_0_o_lin_enable]
  ...
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_mem1a_din [get_bd_pins BRAM_big1/BRAM_key_din] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem1a_din]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_mem1a_en [get_bd_pins BRAM_big1/BRAM_key_en] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem1a_en]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_mem1a_we [get_bd_pins BRAM_big1/BRAM_key_we] [get_bd_pins MAYO_KEYGEN_FSM_0/o_mem1a_we]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_neg_adr [get_bd_pins MAYO_KEYGEN_FSM_0/o_neg_adr] [get_bd_pins mayo_negate_0/i_adr]
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_neg_enable [get_bd_pins MAYO_KEYGEN_FSM_0/o_neg_enable] [get_bd_pins mayo_negate_0/i_enable] [get_bd_pins system_ila_0/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MAYO_KEYGEN_FSM_0_o_neg_enable]
  ...
  connect_bd_net -net MAYO_KEYGEN_FSM_0_o_red_enable [get_bd_pins MAYO_KEYGEN_FSM_0/o_red_enable] [get_bd_pins mayo_reduce_0/i_enable] [get_bd_pins system_ila_0/probe5]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets MAYO_KEYGEN_FSM_0_o_red_enable]
  ...
  connect_bd_net -net MAYO_SHAKE_1_BRAMA_addr [get_bd_pins BRAM_big1/BRAM_hash_addr] [get_bd_pins hash/BRAMA_addr]
  connect_bd_net -net MAYO_SHAKE_1_BRAMA_din [get_bd_pins BRAM_big1/BRAM_hash_din] [get_bd_pins hash/BRAMA_din]
  connect_bd_net -net MAYO_SHAKE_1_BRAMA_en [get_bd_pins BRAM_big1/BRAM_hash_en] [get_bd_pins hash/BRAMA_en]
  connect_bd_net -net MAYO_SHAKE_1_BRAMA_we [get_bd_pins BRAM_big1/BRAM_hash_we] [get_bd_pins hash/BRAMA_we]
  ...
  connect_bd_net -net add_control_1 [get_bd_pins BRAM_big1/add_control] [get_bd_pins mayo_add_vectors_0/o_controlc]
  ...
  connect_bd_net -net arbit_brama1_BRAM_hash_dout [get_bd_pins BRAM_big1/BRAM_hash_dout] [get_bd_pins hash/BRAMA_dout]
  connect_bd_net -net arbit_brama1_BRAM_key_dout1 [get_bd_pins BRAM_big1/BRAM_key_dout] [get_bd_pins MAYO_KEYGEN_FSM_0/i_mem1a_dout]
  ...
  connect_bd_net -net blink_led_0_led4 [get_bd_ports LD4] [get_bd_pins blink_led_0/led4]
  connect_bd_net -net blink_led_0_led5 [get_bd_ports LD5] [get_bd_pins blink_led_0/led5]
  ...
  connect_bd_net -net hash_control_1 [get_bd_pins BRAM_big1/hash_control] [get_bd_pins hash/BRAM1_control]
  ...
  connect_bd_net -net mayo_add_vectors_0_o_memc_addr [get_bd_pins BRAM_big1/BRAM_add_addr] [get_bd_pins mayo_add_vectors_0/o_memc_addr]
  connect_bd_net -net mayo_add_vectors_0_o_memc_din [get_bd_pins BRAM_big1/BRAM_add_din] [get_bd_pins mayo_add_vectors_0/o_memc_din]
  connect_bd_net -net mayo_add_vectors_0_o_memc_en [get_bd_pins BRAM_big1/BRAM_add_en] [get_bd_pins mayo_add_vectors_0/o_memc_en]
  connect_bd_net -net mayo_add_vectors_0_o_memc_rst [get_bd_pins BRAM_big1/BRAM_add_rst1] [get_bd_pins mayo_add_vectors_0/o_memc_rst]
  connect_bd_net -net mayo_add_vectors_0_o_memc_we [get_bd_pins BRAM_big1/BRAM_add_we1] [get_bd_pins mayo_add_vectors_0/o_memc_we]
  connect_bd_net -net mayo_axi_litev3_0_o_Debug [get_bd_pins MAYO_KEYGEN_FSM_0/i_debug] [get_bd_pins mayo_axi_litev3_0/o_Debug]
  connect_bd_net -net mayo_axi_litev3_0_o_Expose [get_bd_pins MAYO_KEYGEN_FSM_0/i_expose] [get_bd_pins mayo_axi_litev3_0/o_Expose]
  connect_bd_net -net mayo_axi_litev3_0_o_Keygen_en [get_bd_pins MAYO_KEYGEN_FSM_0/ENABLE] [get_bd_pins mayo_axi_litev3_0/o_Keygen_en]
  ...
  connect_bd_net -net mayo_hash_arbiter_0_o_key_done [get_bd_pins MAYO_KEYGEN_FSM_0/i_hash_done] [get_bd_pins hash/o_key_done] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mayo_hash_arbiter_0_o_key_done]
  ...
  connect_bd_net -net mayo_linear_combinat_0_o_control1a [get_bd_pins BRAM_big1/lin_control] [get_bd_pins mayo_linear_combinat_0/o_control1a]
  ...
  connect_bd_net -net mayo_linear_combinat_0_o_mem1a_addr [get_bd_pins BRAM_big1/BRAM_lin_addr] [get_bd_pins mayo_linear_combinat_0/o_mem1a_addr]
  connect_bd_net -net mayo_linear_combinat_0_o_mem1a_din [get_bd_pins BRAM_big1/BRAM_lin_din] [get_bd_pins mayo_linear_combinat_0/o_mem1a_din]
  connect_bd_net -net mayo_linear_combinat_0_o_mem1a_en [get_bd_pins BRAM_big1/BRAM_lin_en] [get_bd_pins mayo_linear_combinat_0/o_mem1a_en]
  connect_bd_net -net mayo_linear_combinat_0_o_mem1a_rst [get_bd_pins BRAM_big1/BRAM_lin_rst] [get_bd_pins mayo_linear_combinat_0/o_mem1a_rst]
  connect_bd_net -net mayo_linear_combinat_0_o_mem1a_we [get_bd_pins BRAM_big1/BRAM_lin_we] [get_bd_pins mayo_linear_combinat_0/o_mem1a_we]
  ...
  connect_bd_net -net mayo_reduce_0_o_addr1 [get_bd_pins BRAM_big1/BRAM_red_addr] [get_bd_pins mayo_reduce_0/o_addr1]
  ...
  connect_bd_net -net mayo_reduce_0_o_control1 [get_bd_pins BRAM_big1/red_control] [get_bd_pins mayo_reduce_0/o_control1]
  connect_bd_net -net mayo_reduce_0_o_din0 [get_bd_pins BRAM_small/BRAM_red_din] [get_bd_pins mayo_reduce_0/o_din0]
  connect_bd_net -net mayo_reduce_0_o_din1 [get_bd_pins BRAM_big1/BRAM_red_din] [get_bd_pins mayo_reduce_0/o_din1]
  connect_bd_net -net mayo_reduce_0_o_done [get_bd_pins MAYO_KEYGEN_FSM_0/i_red_done] [get_bd_pins mayo_reduce_0/o_done]
  connect_bd_net -net mayo_reduce_0_o_en1 [get_bd_pins BRAM_big1/BRAM_red_en] [get_bd_pins mayo_reduce_0/o_en1]
  connect_bd_net -net mayo_reduce_0_o_enb [get_bd_pins BRAM_small/BRAM_red_en] [get_bd_pins mayo_reduce_0/o_en0]
  connect_bd_net -net mayo_reduce_0_o_rst1 [get_bd_pins BRAM_big1/BRAM_red_rst] [get_bd_pins mayo_reduce_0/o_rst1]
  connect_bd_net -net mayo_reduce_0_o_rstb [get_bd_pins BRAM_small/BRAM_red_rst] [get_bd_pins mayo_reduce_0/o_rst0]
  connect_bd_net -net mayo_reduce_0_o_we1 [get_bd_pins BRAM_big1/BRAM_red_we] [get_bd_pins mayo_reduce_0/o_we1]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BRAM_big1/axi_bram_ctrl_0/S_AXI/Mem0] -force
