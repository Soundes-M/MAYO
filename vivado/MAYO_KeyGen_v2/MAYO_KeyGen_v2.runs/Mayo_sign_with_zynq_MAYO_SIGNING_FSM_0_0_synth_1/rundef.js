...
ISEStep( "vivado",
         "-log Mayo_sign_with_zynq_MAYO_SIGNING_FSM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mayo_sign_with_zynq_MAYO_SIGNING_FSM_0_0.tcl" );
