...
#
# Generated by export_simulation on Mon Nov 28 12:52:13 CET 2022
#
################################################################################
...
'-reset_run' switch to the './Test_BRAM0.sh' script.

./Test_BRAM0.sh -reset_run
...
./Test_BRAM0.sh -noclean_files

For more information on the script, please type './Test_BRAM0.sh -help'.
