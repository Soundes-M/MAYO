...
module SHA_SHAKE_wrapper(clk, rst, shake_intermediate_rst, shake_next_extract, rate_type, mlen, 
									rd_address, din,
									olen, dout, wt_address, sample_dout, sample_din,
									done);
...
begin
	...
	else if(domain_separator_used==1'b0 && mlen_g8==1'b0 && state==5'd1)
...
assign sample_din = inc_rd_address;
