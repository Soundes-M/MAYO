...
HD_PWD='/home/osm/Documents/Sect/SECT-MAYO/MAYO/vivado/hw-mayo/hw-mayo.runs/Mayo_sign_TRNG_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mayo_sign_TRNG_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mayo_sign_TRNG_0_0.tcl
