...
ISEStep( "vivado",
         "-log Mayo_sign_with_zynq_mayo_add_vectors_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mayo_sign_with_zynq_mayo_add_vectors_0_1.tcl" );
