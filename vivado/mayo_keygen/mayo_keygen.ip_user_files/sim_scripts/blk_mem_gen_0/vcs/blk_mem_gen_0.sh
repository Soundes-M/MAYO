...
#
# Generated by Vivado on Sun Aug 21 22:43:16 CEST 2022
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_4 $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2020.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../mayo_keygen.gen/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
