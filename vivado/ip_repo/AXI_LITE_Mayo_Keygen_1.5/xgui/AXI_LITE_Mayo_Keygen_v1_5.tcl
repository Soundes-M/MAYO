...
proc update_PARAM_VALUE.BRAM_II_SIZE { PARAM_VALUE.BRAM_II_SIZE } {
	# Procedure called to update BRAM_II_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_II_SIZE { PARAM_VALUE.BRAM_II_SIZE } {
	# Procedure called to validate BRAM_II_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.BRAM_II_SIZE { MODELPARAM_VALUE.BRAM_II_SIZE PARAM_VALUE.BRAM_II_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_II_SIZE}] ${MODELPARAM_VALUE.BRAM_II_SIZE}
}
