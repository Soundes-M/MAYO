...
set id 1
set name hls_linear_combination_urem_32ns_6ns_8_36_seq_1
...
set id 2
set name hls_linear_combination_mac_muladd_8ns_8ns_32ns_32_4_1
...
set ID 5
set hasByteEnable 0
set MemName hls_linear_combination_accumulators
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_r \
    op interface \
    ports { out_r_i { I 8 vector } out_r_o { O 8 vector } out_r_o_ap_vld { O 1 bit } } \
} "
}
