...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hls_linear_combination.autotvin.dat"
	set constFileTvOut       "hls_linear_combination.autotvout.dat"
	set constFileHdlTvIn     "hls_linear_combination.autohdltvin.dat"
	set constFileHdlTvOut    "hls_linear_combination.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
