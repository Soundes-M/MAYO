...
if {[file isfile hls_linear_combination.autotvin.dat]} {
	file delete -force hls_linear_combination.autotvin.dat
}

if {[file isfile hls_linear_combination.autotvout.dat]} {
	file delete -force hls_linear_combination.autotvout.dat
}
