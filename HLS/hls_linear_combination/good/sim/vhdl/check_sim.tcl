...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.hls_linear_combination.autotvin_vecs_V.dat"
         "c.hls_linear_combination.autotvin_coeffs_V.dat"
         "c.hls_linear_combination.autotvin_len.dat"
         "c.hls_linear_combination.autotvin_out_V.dat"
         "c.hls_linear_combination.autotvout_out_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.hls_linear_combination.autotvout_out_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
