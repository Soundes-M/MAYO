...
entity hls_linear_combination_vec_l_0_ram is 
    generic(
            DWIDTH     : integer := 8; 
            AWIDTH     : integer := 10; 
...
architecture rtl of hls_linear_combination_vec_l_0_ram is 
...
entity hls_linear_combination_vec_l_0 is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of hls_linear_combination_vec_l_0 is
    component hls_linear_combination_vec_l_0_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    hls_linear_combination_vec_l_0_ram_U :  component hls_linear_combination_vec_l_0_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
