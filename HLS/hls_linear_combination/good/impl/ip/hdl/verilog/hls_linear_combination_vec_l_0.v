...
// ==============================================================
`timescale 1 ns / 1 ps
module hls_linear_combination_vec_l_0_ram (addr0, ce0, d0, we0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4, addr5, ce5, q5, addr6, ce6, q6, addr7, ce7, q7, addr8, ce8, q8, addr9, ce9, q9,  clk);
...
`timescale 1 ns / 1 ps
module hls_linear_combination_vec_l_0(
    reset,
    clk,
    address0,
    ce0,
...
hls_linear_combination_vec_l_0_ram hls_linear_combination_vec_l_0_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
