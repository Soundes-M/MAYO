...
attribute shreg_extract : string;
    ...
    signal empty_36_fu_160_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal zext_ln103_fu_177_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln103_reg_320 : STD_LOGIC_VECTOR (15 downto 0);
    signal exitcond136_fu_171_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln103_fu_180_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln103_reg_325 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal add_ln109_fu_226_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln109_reg_333 : STD_LOGIC_VECTOR (14 downto 0);
    signal icmp_ln103_fu_186_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln107_fu_231_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln107_reg_338 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal icmp_ln107_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal accumulators_addr_4_reg_351 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal add_ln113_fu_266_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln113_reg_361 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state9 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state9 : signal is "none";
    signal icmp_ln113_fu_277_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_reg_112 : STD_LOGIC_VECTOR (5 downto 0);
    signal i_reg_123 : STD_LOGIC_VECTOR (5 downto 0);
    signal j_reg_134 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal i_2_reg_145 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_CS_fsm_state46 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state46 : signal is "none";
    signal p_cast2_fu_166_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln109_fu_257_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln107_fu_237_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln113_fu_272_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal grp_fu_294_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_shl_fu_192_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl2_fu_204_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_shl_cast_fu_200_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal p_shl2_cast_fu_212_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_39_fu_216_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal sext_ln107_fu_222_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal zext_ln107_2_fu_242_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal add_ln109_3_fu_252_p2 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal grp_fu_283_ap_start : STD_LOGIC;
    signal grp_fu_283_ap_done : STD_LOGIC;
    signal ap_NS_fsm : STD_LOGIC_VECTOR (45 downto 0);
    signal grp_fu_294_p00 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    urem_32ns_6ns_8_36_seq_1_U11 : component computeP2_urem_32ns_6ns_8_36_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    mac_muladd_8ns_8ns_32ns_32_4_1_U12 : component computeP2_mac_muladd_8ns_8ns_32ns_32_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 8,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond136_fu_171_p2 = ap_const_lv1_0))) then 
                empty_reg_112 <= empty_36_fu_160_p2;
            elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                empty_reg_112 <= ap_const_lv6_0;
            end if; 
        end if;
    end process;

    i_2_reg_145_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln103_fu_186_p2 = ap_const_lv1_1))) then 
                i_2_reg_145 <= ap_const_lv6_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond136_fu_171_p2 = ap_const_lv1_1))) then 
                i_reg_123 <= ap_const_lv6_0;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln107_fu_246_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln103_fu_186_p2 = ap_const_lv1_0))) then 
                j_reg_134 <= ap_const_lv6_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln107_fu_246_p2 = ap_const_lv1_0))) then
                accumulators_addr_4_reg_351 <= zext_ln107_fu_237_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond136_fu_171_p2 = ap_const_lv1_1))) then
                    zext_ln103_reg_320(7 downto 0) <= zext_ln103_fu_177_p1(7 downto 0);
            end if;
        end if;
    end process;
    zext_ln103_reg_320(15 downto 8) <= "00000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, exitcond136_fu_171_p2, ap_CS_fsm_state3, icmp_ln103_fu_186_p2, ap_CS_fsm_state4, icmp_ln107_fu_246_p2, ap_CS_fsm_state9, icmp_ln113_fu_277_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (icmp_ln107_fu_246_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
            ...
            when ap_ST_fsm_state9 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln113_fu_277_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    accumulators_address0_assign_proc : process(ap_CS_fsm_state2, accumulators_addr_4_reg_351, ap_CS_fsm_state9, ap_CS_fsm_state8, p_cast2_fu_166_p1, zext_ln113_fu_272_p1, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
            accumulators_address0 <= zext_ln113_fu_272_p1(6 - 1 downto 0);
            ...
            accumulators_address0 <= p_cast2_fu_166_p1(6 - 1 downto 0);
        else 
    ...
    accumulators_d0_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_state8, grp_fu_294_p3)
    begin
    ...
    accumulators_we0_assign_proc : process(ap_CS_fsm_state2, exitcond136_fu_171_p2, ap_CS_fsm_state8)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state8) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond136_fu_171_p2 = ap_const_lv1_0)))) then 
    ...
    add_ln103_fu_180_p2 <= std_logic_vector(unsigned(i_reg_123) + unsigned(ap_const_lv6_1));
    add_ln107_fu_231_p2 <= std_logic_vector(unsigned(j_reg_134) + unsigned(ap_const_lv6_1));
    add_ln109_3_fu_252_p2 <= std_logic_vector(unsigned(add_ln109_reg_333) + unsigned(zext_ln107_2_fu_242_p1));
    add_ln109_fu_226_p2 <= std_logic_vector(signed(sext_ln107_fu_222_p1) + signed(vecs_offset));
    add_ln113_fu_266_p2 <= std_logic_vector(unsigned(i_2_reg_145) + unsigned(ap_const_lv6_1));
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state9, icmp_ln113_fu_277_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln113_fu_277_p2 = ap_const_lv1_1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state9, icmp_ln113_fu_277_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state9) and (icmp_ln113_fu_277_p2 = ap_const_lv1_1))) then 
    ...
    empty_36_fu_160_p2 <= std_logic_vector(unsigned(empty_reg_112) + unsigned(ap_const_lv6_1));
    empty_39_fu_216_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_200_p1) - unsigned(p_shl2_cast_fu_212_p1));
    exitcond136_fu_171_p2 <= "1" when (empty_reg_112 = ap_const_lv6_3C) else "0";

    grp_fu_283_ap_start_assign_proc : process(ap_CS_fsm_state11)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            grp_fu_283_ap_start <= ap_const_logic_1;
        else 
            grp_fu_283_ap_start <= ap_const_logic_0;
        end if; 
    end process;

    grp_fu_283_p1 <= ap_const_lv32_1F(6 - 1 downto 0);
    grp_fu_294_p0 <= grp_fu_294_p00(8 - 1 downto 0);
    grp_fu_294_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(vecs_q0),16));
    grp_fu_294_p1 <= zext_ln103_reg_320(8 - 1 downto 0);
    icmp_ln103_fu_186_p2 <= "1" when (i_reg_123 = ap_const_lv6_38) else "0";
    icmp_ln107_fu_246_p2 <= "1" when (j_reg_134 = ap_const_lv6_3C) else "0";
    icmp_ln113_fu_277_p2 <= "1" when (i_2_reg_145 = ap_const_lv6_3C) else "0";
    out_r <= grp_fu_283_p2(8 - 1 downto 0);

    out_r_ap_vld_assign_proc : process(ap_CS_fsm_state46)
    begin
    ...
    p_cast2_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_112),64));
    p_shl2_cast_fu_212_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl2_fu_204_p3),13));
    p_shl2_fu_204_p3 <= (i_reg_123 & ap_const_lv2_0);
    p_shl_cast_fu_200_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl_fu_192_p3),13));
    p_shl_fu_192_p3 <= (i_reg_123 & ap_const_lv6_0);
        sext_ln107_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(empty_39_fu_216_p2),15));

    vecs_address0 <= zext_ln109_fu_257_p1(15 - 1 downto 0);
    ...
    zext_ln103_fu_177_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(coeffs_read),16));
    zext_ln107_2_fu_242_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_134),15));
    zext_ln107_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_reg_134),64));
    zext_ln109_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln109_3_fu_252_p2),64));
    zext_ln113_fu_272_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_2_reg_145),64));
end behav;
